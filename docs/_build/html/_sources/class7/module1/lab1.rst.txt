...
.. NOTE::
  ...
  - Web site up and running at 10.1.20.200:80, 10.1.20.201:80 and 10.1.20.202:80
...
#. **Add** the following “new node” members to the pool, then click **Finished**:
   ...
   -  Node Name: **server1**, Address: **10.1.20.200**, Service Port **80**

   -  Node Name: **server2**, Address: **10.1.20.201**, Service Port **80**

   -  Node Name: **server3**, Address: **10.1.20.202**, Service Port **80**
...
#. Name the Virtual Server in the following format **http\_vs\_redir**.
   For “Destination Address/Mask”, use **10.1.10.10"**. For “Service
   Port”, use **80**.
